    ...
    <main>
      <section className={styles.imgContainer}>
        <img
          ...
          alt="Overzicht van Walibi Holland"
        />
        <div className={styles.redOverlay}></div>
        <div className={styles.imgText}>
          <h1>Ontdek de attracties!</h1>
          <p>Bekijk alle spectaculaire attracties van Walibi Holland</p>
        </div>
      </section>

      <section className={styles.alleAttracties}>
        ...
        <div className={styles.cardContent} id="yoy">
          <img src="https://www.looopings.nl/img/foto/25/0415hacasel.jpg" alt="Yoy achtbaan" />
          <div className={styles.cardText}>
            <h2>Yoy</h2>
        ...
        <div className={styles.cardContent} id="xpress">
          <img src="https://nl.letsgodigital.org/uploads/2017/11/achtbaan-walibi.jpg" alt="Xpress platform 13 achtbaan" />
          <div className={styles.cardText}>
        ...
        <div className={styles.cardContent} id="elriogrande">
          <img src="https://www.pretparken.be/dynamic_pics/thumb_78b3509b8e4ab387411dd177c1888bd9_1280_960_1.jpg" alt="El Rio Grande waterattractie" />
          <div className={styles.cardText}>
            <h2>El Rio Grande</h2>
        ...
        <div className={styles.cardContent} id="merlinsMagicCastle">
          <img src="https://www.walibi.nl/adobe/dynamicmedia/deliver/dm-aid--d2ce72b9-fd41-4c06-a5ad-09c338872463/attractie-merlinsmagiccastle-1.jpg?preferwebp=true&quality=85" alt="Merlin's Magic Castle" />
          <div className={styles.cardText}>
        ...
        <div className={styles.cardContent} id="crazyRiver">
          <img src="https://www.walibi.nl/adobe/dynamicmedia/deliver/dm-aid--082f6e19-1e93-4a43-b041-2905839d1896/crazy-river.jpg?quality=85&preferwebp=true" alt="Crazy River waterbaan" />
          <div className={styles.cardText}>
            <h2>Crazy River</h2>
        ...
        <div className={styles.cardContent} id="tomahawk">
          <img src="https://www.walibi.nl/adobe/dynamicmedia/deliver/dm-aid--72903adb-7d9f-43dc-8342-75acca77242f/attractie-thomahawk-5.jpg?quality=85&preferwebp=true" alt="Tomahawk draaimolen" />
          <div className={styles.cardText}>
            <h2>Tomahawk</h2>
            <p><strong>Minimale lengte:</strong> 90 cm</p>
        ...
        <div className={styles.cardContent} id="spinningVibe">
          <img src="https://www.walibi.nl/adobe/dynamicmedia/deliver/dm-aid--06ddbd13-bd12-4de5-94f9-5df850fabfe1/attractie-spinningvibe-2-oud.jpg?quality=85&preferwebp=true" alt="Spinning Vibe" />
          <div className={styles.cardText}>
            <h2>Spinning Vibe</h2>
            <p><strong>Minimale lengte:</strong> 120 cm</p>
        ...
        <div className={styles.cardContent} id="blast">
          <img src="https://www.looopings.nl/img/foto/23/0416blast1.jpg" alt="Blast achtbaan" />
          <div className={styles.cardText}>
            <h2>Blast</h2>
            <p><strong>Minimale lengte:</strong> 120 cm</p>
